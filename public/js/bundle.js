...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } //import { login } from '../../controllers/authController';
...
var logout = exports.logout = function logout() {
  (0, _axios.default)({
    ...
    if (response.data.status === 'success') {
      ...
      (0, _alerts.showAlert)('success', "logout success");
      window.setInterval(function () {
        window.location = '/';
      }, 1000);
    }
          ...
          try {
            ...
            res = (0, _axios.default)({
              ...
              if (res.data.status === 'success') {
                ...
                var photo = "/img/users/".concat(res.data.data.user.photo);
                console.log(photo);
                var el = document.querySelector('.nav--user a span');
                el.innerText = res.data.data.user.name;
                var el1 = document.querySelector('.nav__user-img');
              ...
              (0, _alerts.showAlert)('error', er.response.data.message);
            });
          } catch (err) {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51PKHT1P39QBpr3kttoU2KfmOpYfSZHsRmuTyonDY1SGUzkPQpfLgSw48BXKGv5zBKdgjPPCTAk1YLxb2fcDMCaV800DiWGrHCS'); //get checkout session from api
          _context.next = 4;
...
var logoutUser = document.querySelector('.nav__el--logout');
var loginForm = document.getElementById('my-form');
var updForm = document.getElementById('updateUserForm');
var pwdForm = document.querySelector('.form-user-password');
...
if (pwdForm) {
  pwdForm.addEventListener('submit', function (e) {
    ...
    var confPwd = document.getElementById('password-confirm').value;
...
if (mapObj) {
  var locations = JSON.parse(mapObj.dataset.locations);
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    console.log((0, _stripe.bookTour)(tourId));
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "16276" + '/');
